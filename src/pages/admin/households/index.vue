<template>
    ...
    <v-container>
        ...
        <v-navigation-drawer
            stateless
            value="true"
            v-model="showHousheoldDetailDrawer"
            right
            fixed
            clipped
            width="500"
        ...
        <v-layout column fill-height justify-center>
            ...
            <v-layout row wrap>
                ...
                <v-flex xs12 sm6 md5 offset-md1 lg5 offset-lg1 xl5 offset-xl1>
...
export default {
    ...
    computed: {
        showHousheoldDetailDrawer () {
            return this.$vuetify.breakpoint.name == 'xs' && this.householdsDetailDrawer
        },
